...
The MSE max on the test data set is 0.309 over 216 test samples.

The MSE mean on the test data set is 0.149 over 216 test samples.

The MSE sort on the test data set is 0.146 over 216 test samples.

The MSE sort on the adv test data set is 0.417 over 216 test samples.
'''